...
from models import FinalRowWise_layer_generator
...
class Model(nn.Module):
    def __init__(self, args, data, model_normal):
        ...
        self.pre_win = args.generator_prewin
        ...
        ## regression ##1       
            self.linears.append(FinalRowWise_layer_generator.FR_Model(args, self.reduce_dim)); #k->k  
            self.sparse_label.append(1); self.orthgonal_label.append(0);  
    ...
    def forward(self, inputs, model_normal):
        ...
        for window_i in range(self.w):
            #hn = self.linears[0](x[:, window_i, :], hn)  #mxq
